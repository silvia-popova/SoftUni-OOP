...
namespace _08.GenericList
{
       ...
       where T : IComparable
    {
        ...
        public T Max()
        {
            ...
            {
                if (this.array[index].CompareTo(max) > 0)
                {
        ...
        {
            T firstElement = this.array[firstIndex];
            this.array[firstIndex] = this.array[secondIndex];
            this.array[secondIndex] = firstElement;
        }

        //public int CompareTo(T firstElement, T secondRlement)
        //{
        //    return firstElement.CompareTo(secondRlement);
        //}

        public int GreaterThan<T>(T elementToCompare)
             where T : IComparable
        {
            int count = 0;
            ...
            {
                if (this[index].CompareTo(elementToCompare) > 0)
                {
                    count++;
                }
            }
        ...
        public bool Contains(T elementToCheck)
        {
            for (int i = 0; i < this.Count; i++)
            {
                ...
                if (currentElement.CompareTo(elementToCheck) == 0)
                {
                    return true;
                }
            }
